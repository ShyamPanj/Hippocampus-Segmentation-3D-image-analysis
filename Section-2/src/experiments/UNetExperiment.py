...
class UNetExperiment:
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # ANSWER: Our first dimension represents the batch size, the second represent the probability 
            # while our remainding two dimensions are for our 2D torch tensor
